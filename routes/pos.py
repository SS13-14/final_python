...
def createPos():
    try:
        ...
        result = connection.execute(
            text(f"INSERT INTO sale (date, customer_id, received_amount) VALUES ('2023-12-26', 1, {received_amount})"))
        ...
        message = (
            ...
            cash_return=last_sale[0]['received_amount'] - sum(
                item['qty'] * item['price'] for item in last_sale_detail_obj),
            date=date.today()
        )
        ...
        bot_token = "6459999505:AAEIcLNf5pZWkir6TF7S4V3pfHeetr8OEEc"
        chat_id = "@Linuxss1314_Manit"
